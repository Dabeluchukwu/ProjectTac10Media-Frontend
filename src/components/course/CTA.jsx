...
const CTA = ({ data, onPrimaryClick, onSecondaryClick }) => {
  ...
  // If onPrimaryClick/onSecondaryClick are provided, use them as onClick handlers
  // Otherwise, treat them as paths for Link components
  const PrimaryComponent = typeof onPrimaryClick === 'string' ? Link : 'button';
  const SecondaryComponent = typeof onSecondaryClick === 'string' ? Link : 'button';

  const primaryProps = typeof onPrimaryClick === 'string' 
    ? { to: onPrimaryClick } 
    : { type: 'button', onClick: onPrimaryClick };

  const secondaryProps = typeof onSecondaryClick === 'string' 
    ? { to: onSecondaryClick } 
    : { type: 'button', onClick: onSecondaryClick };
